...
switch ($action) {
    ...
    case 'Seach':
        if (isset($_POST['Timkiem'])) {
            ...
            $list_sv = $sinhvienModel->Seach($gtTimkiem);
        }
    ...
    case 'Add_hocky':
        if (isset($_POST['themHocky'])) {
            ...
            if (Hocky::ADD($txt_mahocky,$txt_tenhocky)) {
    ...
    case 'Edit':
        ...
        if (isset($_GET['maSV'])) {
            ...
            if (isset($_POST['Edit'])) {
                ...
                if (Sinhvien::Edit($txt_masv,$txt_hoten,$ngaysinh,$txt_gioitinh,$txt_dantoc,$txt_noisinh,$txt_malop,$maSV)) {
                    header("location:index.php?controllers=quanly&action=Admin");
                }
                else
                {
